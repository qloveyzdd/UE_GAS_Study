...
AUE_GAS_StudyCharacter::AUE_GAS_StudyCharacter()
{
...
void AUE_GAS_StudyCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AUE_GAS_StudyCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUE_GAS_StudyCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
